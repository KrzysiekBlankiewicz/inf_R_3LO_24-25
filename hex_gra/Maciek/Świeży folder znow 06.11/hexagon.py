...
def rysuj(xcenter,ycenter,q,r,s,a, offset, screen, color):
    ...
    defg=wierzch(abc[0],abc[1],a-offset)
    hexa_points=[]
...
class Hexagon:
    ...
    def daj_pion_pos(h, xcenter, ycenter, a):
        return(srodek(xcenter, ycenter, h.q,h.r,h.s,a))
